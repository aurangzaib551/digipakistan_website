  ...
  return (
    <Container className="mt pt-4">
      ...
      <p className="text-justify">
        ...
        transactions via the Internet. Online banking is also known as Internet
        banking or web banking. Online banking offers customers almost every
        service traditionally available through a local branch including
        deposits, transfers, and online payments.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              If you applied for 1 Program, add amount: <strong>2000/=</strong>
            </li>
            <li>
              If you applied for 2 Programs, add amount: <strong>4000/=</strong>
            </li>
            <li>
              If you applied for 3 Programs, add amount: <strong>6000/=</strong>
            </li>
          </ul>
        </li>
        <li>
