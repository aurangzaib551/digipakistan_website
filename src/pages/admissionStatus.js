          ...
          <>
            {status ? (
              ...
              <p className="mb-0 h4">
                ...
                DigiPAKISTAN National Skills Development Program. You have to
                wait for 24hrs for application status. Admission Department will
                evaluate your application &amp; update the Applicant Admission
                Status within next 24hrs to this portal. Login again after
                24hrs, in case your application approved you have to proceed
                further &amp; if not eligible try next time.
              </p>
            )}
          </>
        </Alert>
