...
const GenerateChallan = ({
  ...
  return (
    <Container className="mt pt-4">
      ...
      <p className="text-justify">
        Pakistani Students can submit their Registration Fee Voucher at any HBL
        Branch in Pakistan or can pay their registration charges via Online
        Banking. Overseas Students can submit their registration charges via
        Online Banking for Overseas Method.
      </p>
