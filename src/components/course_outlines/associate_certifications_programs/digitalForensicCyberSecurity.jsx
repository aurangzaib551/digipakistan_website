          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Digital Forensic</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    They're the people who collect, process, preserve, and
                    analyze computer-related evidence. They help identify
                    network vulnerabilities and then develop ways to mitigate
                    them. They go deep inside networks, computers, and
                    smartphones in search of evidence of criminal activity.
                  </p>

                  <p className="text-justify">
                    Digital Forensics is the modern day version of forensic
                    science and deals with the recovery and investigation of
                    material found in digital devices. It is most often used in
                    cybercrime situations, including but not limited to:
                    attribution. identifying leaks within an organization.
                  </p>
...
export default DigitalForensic;
