        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Artificial
              Intelligence
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Artificial Intelligence</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    AI includes machine learning as well as deep learning. ...
                    On one hand, machine learning algorithms are helping
                    businesses evolve, and on the other, speech recognition,
                    image processing techniques and fingerprint patterns are
                    taking the world by storm. We use gadgets that are
                    intelligent and makes our everyday tasks easy.
                  </p>
                  ...
                  <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingTwo">
                        ...
                        >
                          Python for Artificial Intlligence
                        </button>
                      </h2>
                      <div
                        id="collapseTwo"
