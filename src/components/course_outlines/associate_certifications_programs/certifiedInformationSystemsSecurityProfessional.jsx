...
const CertifiedInformationSystemSecurityProfessional = () => {
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    knowledge and experience to effectively design, engineer,
                    and manage the overall security posture of an organization.
                    The broad spectrum of topics included in the CISSP Common
                    Body of Knowledge (CBK) ensure its relevancy across all
                    disciplines in the field of information security.
                  </p>
...
export default CertifiedInformationSystemSecurityProfessional;
