        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Blockchain
              Technology
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Blockchain Technology</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    stored globally on thousands of servers – while letting
                    anyone on the network see everyone else's entries in near
                    real-time. That makes it difficult for one user to gain
                    control of, or game, the network.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    corporate relational databases, it does open new doors for
                    the movement and storage of transactional data inside and
                    outside of global enterprises.
                  </p>
                  ...
                  <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        ...
                        >
                          Level-3: This is the advance level when both level has
                          been clear then they will reach to this level
                        </button>
                      </h2>
                      <div
                        id="collapseThree"
