        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Full Stack
              Web Development
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Full Stack Web Development</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    The Microsoft MCSA (Microsoft Certified Solutions
                    Associate): Web Applications certification will teach you a
                    fundamental understanding of HTML5, CSS3 and JavaScript
                    programming. In addition, you will be taught about the
                    development of advanced ASP.NET MVC applications by using
                    .NET Framework 4.5 tools and technologies. Full Stack Web
                    Development would involve creating complex web and mobile
                    applications from start to end. In short, full stack
                    developers are technical wizards who can work anywhere in
                    the stack - who can develop, code, design, manage databases.
                    Full-Stack Software Engineers are highly-skilled experts in
                    the development world. These engineers are familiar coding
                    for both the user-side frontend of a website, as well as the
                    backend, server-side that powers the user-side. Becoming an
                    employable Full-Stack Engineer requires dedication that
                    combines educational and work experience.The technology is
                    advancing day by day, Software application is now everywhere
                    health, foods, education, transportation, fashion, real
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="collapseThree"
                        >
                          Microsoft ASP.NET MVC Web Applications
                        </button>
                      </h2>
                      <div
                        id="collapseThree"
