              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    exploitable vulnerabilities. In the context of web
                    application security, penetration testing is commonly used
                    to augment a web application firewall (WAF).
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    skills to uncover the security threats that organizations
                    are vulnerable to.
                  </p>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="collapseThree"
                        >
                          Certified Security Analyst (ECSA Practical)
                        </button>
                      </h2>
                      <div
                        id="collapseThree"
