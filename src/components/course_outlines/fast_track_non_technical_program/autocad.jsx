        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Autocad
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Autocad</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    other engineering plans. Furthermore, CAD is used in
                    computer software to design and keep a record of the design
                    process of the product. It is one of the recommended design
                    software that brings engineering skills to life with
                    accuracy. Professionals who use Autocad are often known as
                    drafters.
                  </p>
