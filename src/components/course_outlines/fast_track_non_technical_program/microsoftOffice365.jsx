          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Microsoft Office 365</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    provide hands on training in Microsoft Word, Microsoft
                    Excel, Microsoft PowerPoint, Internet and Email
                    applications. These applications fit in all types of the
                    modern working environment. Though, this course is designed
                    for beginners, but it is also useful for people who have
                    basic computer knowledge. It aims at raising and improving
                    the users’ knowledge and competency of computer usage. If
                    you are a person who wishes to explore the world of
                    computing or someone willing to learn computer basics, then
