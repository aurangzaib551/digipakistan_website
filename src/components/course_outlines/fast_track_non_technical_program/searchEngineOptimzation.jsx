        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Search
              Engine Optimization
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Search Engine Optimization</h2>
                  ...
                  <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingOne">
                        ...
                        >
                          First of all, Introduction to SEO
                        </button>
                      </h2>
                      <div
                        id="collapseOne"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m1"
                        >
                          Most noteworthy, Industry Experts of SEO
                        </button>
                      </h2>
                      <div
                        id="m1"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m2"
                        >
                          Why is SEO so much important now?
                        </button>
                      </h2>
                      <div
                        id="m2"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m3"
                        >
                          Impact of SEO over the post/pages
                        </button>
                      </h2>
                      <div
                        id="m3"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m17"
                        >
                          Hence, making you learn how to do a complete Site
                          Analysis
                        </button>
                      </h2>
                      <div
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m19"
                        >
                          Finally, Its completion and implementation
                        </button>
                      </h2>
                      <div
                        id="m19"
