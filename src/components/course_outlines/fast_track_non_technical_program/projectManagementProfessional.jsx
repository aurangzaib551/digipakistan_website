...
const ProjectManagementProfessional = () => {
        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Project
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    fundamentals in project management, based on the Guide to
                    the Project Management Body of Knowledge (PMBOK®). This
                    certification is offered by PMI®, USA. PMP Certification is
                  ...
                  <p className="text-justify">
                    In this course, the participants will also go through
                    project management exams in order to consolidate their
                    knowledge. The simulation exams will enable the participants
                    to do their own gap analysis to see how they should focus on
                    their PMP® exam preparation in order to be successful.
                  </p>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m5"
                        >
                          Planning for Risk, Procurements, and Stakeholder
                          Management
                        </button>
                      </h2>
                      <div
