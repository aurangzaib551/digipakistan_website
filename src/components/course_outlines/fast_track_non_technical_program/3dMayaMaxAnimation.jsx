        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; 3D Maya
              Max Animation
            </p>
          </div>
        </div>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    The Autodesk's Max 3D modeling software and Maya 3D are
                    among the widely used software in the field of 3D animation,
                    modeling, simulation and rendering. These are fundamentals
                    for those with the aspiration to a land a career as art
                    directors, modelers, 3D Character designers and more.
                  </p>

                  <p className="text-justify">
                    3D modeling is a highly specialized field. As such, there is
                    a high demand for 3D Modelers in all industries. According
                    to the Bureau of Labor Statistics (BLS), depending on the
                    specialization, employment in this field had grown by 8-14%
                    by 2018.
                  </p>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              FILLING AN EMPTY ROOM WITH NEW OBJECTS MADE USING
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m4"
                        >
                          IMPORTING 2D PLANS FROM AUTOCAD AND MODELING IN 3DS
                          MAX
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              USING SHAPED AND EXTRUDE MODIFIER TO MODEL IN 3DS
                              MAX
                            </li>
                            <li>
                              USING AUTOCAD POLYLINES AND OTHER TECHNIQUES TO
                              MODEL A HOUSE IN 3DS MAX.
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              PREPARING RESULTS FROM MAYA FOR USE WITH OTHER
                              SOFTWARE
                            </li>
                          </ul>
                        </div>
...
export default MAYAMAXANIMATION;
