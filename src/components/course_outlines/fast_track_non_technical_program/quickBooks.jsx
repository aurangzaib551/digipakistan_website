        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Quick
              Books
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Quick Books</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    associated with the application and be able to setup,
                    organize and use different course available in the
                    application. After completing this course, trainees will be
                    able to handle customers, vendors, assets, and inventory and
                    fully benefit from different functionality of the system.
                    They will be able to use available reports and create new
                    ones. Also, they will be able to participate in QuickBooks
                    online jobs.
                  </p>
