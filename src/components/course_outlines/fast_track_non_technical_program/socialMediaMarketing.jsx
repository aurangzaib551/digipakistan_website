        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Social
              Media Marketing
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Social Media Marketing</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    Social Media Marketing is the use of social media websites
                    and social networks to market a company’s products and
                    services. Social media marketing provides companies with a
                    way to reach new customers, engage with existing customers,
                    and promote their desired culture, mission, or tone. Also
                    known as "digital marketing" and "e-marketing," social media
                    marketing has purpose-built data analytics tools that allow
                  ...
                  <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingOne">
                        ...
                        >
                          Introducing Social Media Marketing, Advertising
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingTwo">
                        ...
                        >
                          The Essential Guide to Digital Marketing on Facebook
                        </button>
                      </h2>
                      <div
                        id="collapseTwo"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m2"
                        >
                          Content Creation and Design Thinking
                        </button>
                      </h2>
                      <div
                        id="m2"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m3"
                        >
                          Analytical tools to evaluate performance
                        </button>
                      </h2>
                      <div
                        id="m3"
