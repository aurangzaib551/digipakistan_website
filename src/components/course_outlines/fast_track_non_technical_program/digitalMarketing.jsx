        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Digital
              Marketing
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Digital Marketing</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    as desktop computers, mobile phones and other digital media
                  ...
                  <p className="text-justify">
                    ...
                    today, your competitors are going to take full advantage of
                    it and can easily take you out. Learning digital marketing
                    means increase in your sales, profits, traffic and brand
                    awareness. And we know that entrepreneurs are busy.
                  </p>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Getting on Google and the Benefits of Being on
                              Google
                            </li>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Mobile 102 - Mobile Search Ads Overview and Ad
                              Formats
                            </li>
                            <li>
                              Mobile 103 - Mobile Display &amp; AdMob: Overview
                              and Ad Formats
                            </li>
                            <li>
                              Mobile 104 - Mobile Video Ads Overview and Ad
                              Formats
                            </li>
                            <li>Local – the What, the Why, the How</li>
                            <li>Serve On-The-Go Customers via Mobile Phones</li>
                            <li>
                              Mobile 201 - Campaign Set Up: The Basics of
                              Setting Up a Campaign
                            </li>
                            <li>
                              Mobile 202 - Implementing Ad Formats: Campaign Set
                              Up
                            </li>
                            <li>
                              Mobile 301 - Optimising Mobile Campaigns: Tools
                              and Strategies, With a Focus on Search
                            </li>
                            <li>
                              Mobile 302 - Display Optimisation Tools: Deep Dive
                              Into Display Optimisation Tools
                            </li>
                            <li>
                              Mobile 303 - Reporting Tools: Deep Dive Into
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Multivariate Experiments with Google Website
                              Optimizer
                            </li>
                            <li>
                              Phone Webinar: Website Optimizer, What Should I
                              Test?
                            </li>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Auction Implementation Tools, Ad Formats and
                              Targeting Capabilities
                            </li>
                            <li>
                              Media Strategies and Implementation (Part 1)
                            </li>
                            <li>
                              Media Strategies and Implementation (Part 2)
                            </li>
