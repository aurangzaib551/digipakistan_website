        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Interior
              Design
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Interior Design</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    Course is not merely about decorating a place rather
                    managing it.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    office design and decor. However, there’s more to it than
                    just the inclination; there’s also the ability. Love for
                    decorating the spaces is in the nature of every human. To be
                    a good designer, you need several skills – some are inbuilt
                    and some can be acquired. This program will help the
                    individuals to sharpen their skills, prepare them to join
                    the design industry as event and interior designers, and to
                    have sufficient knowledge of new trends in market.
                  </p>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Learning the method of modular design
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m3"
                        >
                          Juries with professional designers for work critique
