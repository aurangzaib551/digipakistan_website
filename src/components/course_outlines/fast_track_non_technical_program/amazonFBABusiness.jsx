        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Amazon FBA
              Business
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Amazon FBA Business</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    Amazon FBA offers a great opportunity to start your
                    part-time / freelance business or do a full time eCommerce
                    business using Amazon platform
                  </p>

                  <p className="text-justify">
                    Amazon is one of the largest E-Commerce stores across the
                    globe. Amazon has a huge network. And as big of a platform
                    Amazon is, the potential of the marketplace on Amazon is
                    three times bigger than any other eCommerce platforms. You
                    will be shocked at how many people want to purchase your
                    product. It surely is mind blowing.
                  </p>

                  <p className="text-justify">
                    FBA is a business model that Amazon offers, which really is
                    a game-changer for online businesses. Through the FBA
                    program you send your product inventory in bulk to an Amazon
                    warehouse and when a customer purchases your product, Amazon
                    packs up the product and sends it to the respective
                    customers.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    customer service on issues regarding deliveries. You can
                    send in hundreds or thousands of items to Amazon warehouse
                    at the same time instead of running to the post office every
                    day to ship your orders.
                  </p>

                  <p className="text-justify">
                    Out of the top 10,000 sellers on Amazon, 66% of them use
                    FBA. If you enroll in the FBA program, you can systematize
                    order fulfillment by taking advantage of Amazon’s advanced
                    delivery and fulfillment services and earn more sales from
                    Amazon’s coveted Prime customers.
                  </p>
                  ...
                  <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingTwo">
                        ...
                        >
                          How to Source Your Products (Find Product Supplier)
                        </button>
                      </h2>
                      <div
                        id="collapseTwo"
