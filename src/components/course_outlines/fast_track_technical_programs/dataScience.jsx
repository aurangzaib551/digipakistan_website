        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Data
              Science
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Data Science</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    On completion, students will have gained the analytical
                    skills required to open the doors to a lucrative career as a
                    Data Scientist.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    experts are needed in banking and finance, automotive,
                    energy, healthcare, transport, retail, and virtually every
                    domain you can think of. And because data drives decisions -
                    from small regional offices to the boardroom - graduates
                    from bootcamps in Data Science will be directly involved in
                    important strategic decision-making processes.
                  </p>

                  <p className="text-justify">
                    The role of data scientist is now a buzz worthy career. It
                    has staying power in the marketplace and provides
                    opportunities for people who study data science to make
                    valuable contributions to their companies and societies at
                    large. LinkedIn recently picked data scientist as its most
                    promising career of 2019. One of the reasons it got the top
                    spot was that the average salary for people in the role is
                    $130,000.
                  </p>

                  <p className="text-justify">
                    Data science is one of the fastest-growing sectors of the
                    tech industry. In simple words, there is soaring demand for
                    Data professionals yet a huge deficit on the supply side.
                    The course will qualify you for a position as a data
                    scientist or a data analyst. This program will ensure you
                    have the knowledge to kick-start your career in Data
                    Science.
                  </p>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Variables, Data Types &amp; Type Conversion in
                              Python
                            </li>
