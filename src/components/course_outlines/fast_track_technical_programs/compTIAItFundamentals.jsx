        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; CompTIA IT
              Fundaments
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">CompTIA IT Fundaments</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p>
                    ...
                    is right for them or to develop a broader understanding of
                    IT.
                  </p>
                  ...
                  <ul>
                    <li>
                      ...
                      competency for information technology and if it is the
                      right career path for them.
                    </li>
                    <li>
                      ITF+ is the only single certification that covers all
                      areas of IT foundations, creating a broader understanding
                      of IT making it ideal for non-technical professionals.
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    careers, ensuring candidates are better prepared to
                  ...
                  <div className="accordion" id="accordionExample">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>Using a Workstation</li>
                            <li>Using and Managing an OS</li>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingTwo">
                        ...
                        >
                          Using Applications and Databases
                        </button>
                      </h2>
                      <div
                        id="collapseTwo"
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>Using Data Types and Units</li>
                            <li>Using Applications</li>
                            <li>Prograaming and Application development</li>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>Using Device Interfaces</li>
                            <li>Using Perpheral Devices</li>
                            <li>Using Storage Devices</li>
                            <li>Using File Systems</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>Using Access Controls</li>
                            <li>Behavioral Security Concepts</li>
                          </ul>
                        </div>
                      </div>
                    </div>
