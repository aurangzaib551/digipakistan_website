        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; iOS Apps
              Development
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">iOS Apps Development</h2>
                  ...
                  <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>Basics</li>
                            <li>Control Flow & Collections</li>
                            <li>Functions & Closures</li>
                            <li>Closures</li>
                            <li>Object Oriented Programming</li>
                            <li>
                              Problem Solving using Swift (So students can learn
                              how to execute their language skills)
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>MVC (Example Project)</li>
                            <li>MVVM (Example Project)</li>
                          </ul>
                        </div>
                      </div>
                    </div>
