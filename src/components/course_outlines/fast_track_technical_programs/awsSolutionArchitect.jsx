          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">AWS Developer Associate</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    technical cloud strategy, assist with cloud migration
                    efforts, review workload architectures, and provide guidance
                    on how to address high-risk issues.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    foundation of AWS - Network, Compute, Load Balancing,
                    Elastic Scaling, Storage, Monitoring, Security and Cost
                    Estimation.
                  </p>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m6"
                        >
                          Serverless Overviews from a Solution Architect
                          Perspective
                        </button>
                      </h2>
                      <div
