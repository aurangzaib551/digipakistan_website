        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; CompTIA
              Security
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">CompTIA Security</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    CompTIA Security+ is a global certification that validates
                    the baseline skills necessary to perform core security
                    functions and pursue an IT security career.
                  </p>

                  <p className="text-justify">
                    Cybersecurity attacks continue to grow. Increasingly, more
                    job roles are tasked with baseline security readiness and
                    response to address today’s threats. Updates to Security+
                    reflect skills relevant to these job roles and prepare
                    candidates to be more proactive in preventing the next
                    attack. To combat these emerging threats, IT Pros must be
                    able to:
                  </p>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Focusing on more threats, attacks, and
                              vulnerabilities on the Internet from newer custom
                              devices that must be mitigated, such as IoT and
                              embedded devices, newer DDoS attacks, and social
                              engineering attacks based on current events.
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Includes coverage of enterprise environments and
                              reliance on the cloud, which is growing quickly as
                              organizations transition to hybrid networks.
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Expanded to focus on administering identity,
                              access management, PKI, basic cryptography,
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Covering organizational security assessment and
                              incident response procedures, such as basic threat
                              detection, risk mitigation techniques, security
                              controls, and basic digital forensics.
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Expanded to support organizational risk management
                              and compliance to regulations, such as PCI-DSS,
                              SOX, HIPAA, GDPR, FISMA, NIST, and CCPA.
                            </li>
                          </ul>
                        </div>
                      </div>
