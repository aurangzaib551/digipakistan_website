              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    <strong>AJAX &amp; JSON</strong> for consuming REST
                    Services. The course also covers essentials of{" "}
                  ...
                  <p className="text-justify">
                    ...
                    today and in the future. As a front end developer, your
                    career is safe and secure with high opportunities. The
                    business wants front end developer for business growth.
                  </p>
                ...
                <Tab eventKey="contact" title="Instructor">
                  <div className="d-flex flex-sm-row flex-column px-3 justify-content-center align-items-center mb-5">
                    ...
                    <div className="ms-3">
                      <h5 className="fw-bold">JAZIB ALEEM</h5>
                      <p>Instructor</p>
                      <p className="mb-0">
                        orporate Trainer SQL Database, Android & iOS, Web
                        Development, Java, C#, PHP, C++, Data Migration,
                        MongoDB, NodeJS, ReactJS, React Native and Laravel
                      </p>
                    </div>
                  </div>
                </Tab>
