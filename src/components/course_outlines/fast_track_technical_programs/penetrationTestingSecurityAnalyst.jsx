            ...
            <div className="col-lg-9 mt-4 mt-lg-5">
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    The EC-Council Certified Security Analyst Certification is
                    an advanced security certification that complements the
                    Certified Ethical Hacker (CEH) certification by validating
                    the analytical phase of ethical hacking. An ECSA is a step
                    ahead of a CEH by being able to analyze the outcome of
                    hacking tools and technologies.
                  </p>

                  <p className="text-justify">
                    Penetration testing, in simple terms is a simulation of a
                    process, a hacker would use to launch an attack on a
                    business network, attached devices, network applications, or
                    a business website. The purpose of training is to protect
                    security issues before hackers can locate them and perform
                    an exploit.
                  </p>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m4"
                        >
                          Network Penetration Testing Methodology – Perimeter
                          Devices
                        </button>
                      </h2>
                      <div
