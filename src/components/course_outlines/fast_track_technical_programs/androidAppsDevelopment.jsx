              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    Google, and other companies. This Course will teach you
                    basic Android application development and will also take you
                    through some advanced concepts related to Android
                  ...
                  <p className="text-justify">
                    ...
                    <strong>basic to advance level</strong> of Android
                    application development.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    programming language so if you have the basic understanding
                    of Java programming then it will be fun to learn Android
                    application development.
                  </p>
                  ...
                  <p className="text-justify">
                    ...
                    <strong>
                      ability to learn advanced topics through self-study
                      methods we will teach them.
                    </strong>
                  </p>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              NEW TOPICS: Since each new version of Android has
                              new features, we keep extra time for adding custom
                              topics in every batch. You can request any Android
                              Topic.
                            </li>
                          </ul>
                        </div>
