        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; PHP
              Laravel
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">PHP Laravel</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    primarily used for web development. In simpler words, it is
                    a language that is used to build, operate and run websites
                    from the back end. It is a general purpose language and can
                    be learned by all people even if they do not have any
                    background. In this project-based course students will learn
                    ...
                    <strong>
                      ...
                      and Configuration of Laravel Framework, database
                      development using Eloquent (Laravel ORM Framework) and
                      MySql.
                    </strong>{" "}
                    ...
                    course also covers{" "}
                    <strong>REST APIs / REST Services</strong> development using{" "}
                    <strong>PHP and Laravel Framework.</strong>
                  </p>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m8"
                        >
                          LARAVEL FUNDAMENTALS- MVC concept and other
                        </button>
                      </h2>
                      <div
                        id="m8"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m8"
                        >
                          Laravel Fundamentals- Laravel Blade Template
                        </button>
                      </h2>
                      <div
                        id="m8"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m14"
                        >
                          Building a Classified application
                        </button>
                      </h2>
                      <div
                        id="m14"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="headingThree">
                        <button
                          ...
                          aria-controls="m15"
                        >
                          PROJECT: CREATE A BASIC ECOMMERCE SITE IN LARAVEL-
                          ADMIN PANEL
                        </button>
                      </h2>
                      <div
