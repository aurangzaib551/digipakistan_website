        ...
        <div className="bg-img">
          <div className="container pt-5">
            ...
            <p className="mb-0 small fw-bold text-white">
              Home &bull; Available Programs &bull; Fast Track &bull; Kotlin
              Apps Development
            </p>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-9 mt-4 mt-lg-5">
              <div className="d-flex justify-content-between align-items-center">
                <h2 className="fw-bold mb-0">Kotlin Apps Development</h2>
              ...
              >
                <Tab eventKey="home" title="Overview">
                  ...
                  <p className="text-justify">
                    ...
                    applications using <strong>Kotlin</strong>. The course
                    covers{" "}
                    <strong>
                  ...
                  <p className="text-justify">
                    <strong>Kotlin</strong> is an open-source, modern
                    programming language that lets developers use both{" "}
                    <strong>
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Set up the development environment and create a
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            ...
                            <li>
                              Explore arranging elements with the Android
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Learn how to build apps that contain multiple
                              screens known as destinations
                            </li>
                            <li>
                              Use Android Studio tools to create and visualize a
                              map
                            </li>
                            <li>or graph</li>
                            <li>
                              of destinations that show navigation paths in your
                              app
                            </li>
                            <li>
                              Learn the navigation patterns and user interface
                              that Android users expect to see
                            </li>
                            <li>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Build a Sleep Quality Tracker app and use a
                              database to store the data over time
                            </li>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Use RecyclerView to make significant improvements
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Build an application that connects to an internet
                              server to retrieve and display live data
                            </li>
                            <li>Simplify fetching data and images</li>
                            <li>
                              to make sure the app reasonably conforms to
                              networking and image loading best practices
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Learn how to implement offline caching by building
                              an app that lets users watch DevByte videos
                            </li>
                            <li>
                              Take an online-only app and transform it to work
                              offline by adding offline caching
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <ul>
                            <li>
                              Improve your app design to support multiple
                              languages as well as support multiple device sizes
                              and orientations
                            </li>
                            <li>
                              Learn how to make your app accessible for users
                              who might need assistance navigating
                            </li>
                            <li>
                              like supporting talkback and push button
                              navigation
                            </li>
                          </ul>
                        </div>
